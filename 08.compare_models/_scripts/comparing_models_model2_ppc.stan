...
transformed parameters {
  ...
  //no loop: for (s in 1:nSubjects) {} not needed because automatically vectorised?
...
generated quantities {
  ...
  real log_lik[nSubjects, nTrials]; //why was this added -- because we had to loop by trials and not per subject?
